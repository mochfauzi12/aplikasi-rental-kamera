...
<div class="page-header">
	<h3>Dashboard Sewa Kamera Cirebon </h3>
</div>
			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge">
							<?php echo $this->m_rental->get_data('kamera')->num_rows(); ?>
						</div>
						<div>Jumlah Kamera</div>
					</div>
				</div>
			</div>
			<a href="<?php echo base_url() . 'admin/kamera' ?>">
...
<div class="row">
	<div class="col-lg-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-random arrow-right"></i> Kamera</h3>
			</div>
			<div class="panel-body">
				<div class="list-group">
					<?php foreach ($kamera as $m) { ?>
					<a href="#" class="list-group-item">
						<span class="badge"><?php if ($m->kamera_status == 1) {
																										echo "Tersedia";
																									} else {
																										echo "Dirental";
																									} ?></span>												
						<i class="glyphicon glyphicon-user"></i> <?php echo $m->kamera_merk; ?>
					</a>				
					<?php 
			} ?>
				</div>
				<div class="text-right">
					<a href="<?php echo base_url() . 'admin/kamera' ?>">Lihat Semua Kamera SKC <i class="glyphicon glyphicon-arrow-right"></i></a>
				</div>				
			</div>
		</div>
	</div>
