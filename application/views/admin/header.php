...
<html>
<head>
	<title>Dashboard - Aplikasi Sewa Kamera Cirebon</title>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url() . 'admin'; ?>">Sewa Kamera</a>
			</div>
			
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="<?php echo base_url() . 'admin'; ?>"><span class="glyphicon glyphicon-home"></span> Dashboard SKC <span class="sr-only">(current)</span></a></li>
					<li><a href="<?php echo base_url() . 'admin/kamera'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Kamera</a></li>
					<li><a href="<?php echo base_url() . 'admin/kostumer'; ?>"><span class="glyphicon glyphicon-user"></span> Data Kostumer</a></li>
					<li><a href="<?php echo base_url() . 'admin/transaksi'; ?>"><span class="glyphicon glyphicon-sort"></span> Transaksi Sewa Kamera</a></li>
